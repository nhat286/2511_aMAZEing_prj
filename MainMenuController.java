...
public class MainMenuController extends Controller{
    ...
    public void handleStartButton() {
		System.out.println("clicked start go to a select level");
		//GameplayStage gs = new GameplayStage(this.getS(), 1);
		//gs.start();
		Screen levelScreen = new Screen(super.getS(), "Level Screen", "/view/levelScreen.fxml");
		levelScreenController levelController = new (super.getS());
		levelScreen.start(levelScreenController);
    }
